...
import { Search, Plus, CheckCircle, Star, Calendar, Lock } from 'lucide-react';
  ...
  return (
    <aside className="w-80 bg-white border-r border-gray-200 p-6 overflow-y-auto">
          ...
          {communities.map((community) => (
            ...
            >
              <div className="w-10 h-10 bg-purple-600 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">{community.logo}</span>
              </div>
      ...
      <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Airdrop Medals</h3>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-white rounded-lg">
            <span className="text-sm font-medium text-gray-700">Activate BIC Wallet</span>
          ...
          <div className="flex items-center justify-between p-3 bg-gray-100 rounded-lg">
            <span className="text-sm font-medium text-gray-500">Install BIC Group app</span>
            <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center justify-between p-3 bg-gray-100 rounded-lg">
            <span className="text-sm font-medium text-gray-500">Verify your account (KYC)</span>
            <div className="flex items-center space-x-2">
              <Lock size={14} className="text-gray-400" />
              <button className="px-3 py-1 bg-gray-400 text-white text-xs rounded-lg cursor-not-allowed">
                Verify
      ...
      <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Get Premium</h3>
      ...
      <div className="bg-gray-50 rounded-xl p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Welcome to Beincom (BIC)</h3>
        <div className="space-y-3">
          <a
            href="#"
