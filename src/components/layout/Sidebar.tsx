    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="hidden lg:flex absolute -right-3 top-6 w-6 h-6 bg-white border border-gray-200 rounded-full items-center justify-center hover:shadow-md transition-all"
        >
          <ChevronRight
            size={16}
            className={cn(
        ...
        <div className="p-4 lg:p-6 overflow-y-auto h-full">
          ...
          {/* Premium Promo - Hidden when collapsed */}
          {!isCollapsed && (
            <div className="mb-6">
              <PremiumPromo />
            </div>
          ...
          {/* Airdrop Medals Panel - Hidden when collapsed */}
          {!isCollapsed && (
          ...
          {/* Welcome Panel - Hidden when collapsed */}
          {!isCollapsed && (
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600 mt-4">
                  Beincom (BIC) Project - Building the future of social
                  communities.
                </p>
              </div>
            </div>
